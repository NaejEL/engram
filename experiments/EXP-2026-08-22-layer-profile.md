...
3. **Avis d'experts. — TRANCHÉE PAR LE PI (2026-08-22) : OUI.** L'avis du labo (tours Math et Neuro) est **requis avant toute implémentation** de `eval/layer_profile.py`, et non seulement avant pré-enregistrement. Motif : les deux tours sur v3 ont trouvé des clauses **fausses** à chaque passage ; I2 n'a aucune raison d'y échapper — pas plus qu'il n'a d'exemption du banc D14-S. **Tour lancé le 2026-08-22**, en parallèle du banc (les experts revoient la logique du protocole, qui ne dépend pas de l'état du banc).
...
- 2026-08-22 : **PI — question 3 tranchée : OUI**, tour Math/Neuro requis **avant
  implémentation**. Tour lancé le jour même, en parallèle du banc.
